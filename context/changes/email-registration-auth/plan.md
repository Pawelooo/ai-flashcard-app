...
- [ ] 3.3 Correct email+password login succeeds for verified account
- [ ] 3.4 Wrong email or password shows identical generic error
- [ ] 3.5 Correct credentials for unverified account show distinct message
- [ ] 3.6 Legacy account logs in via old username
- [ ] 3.7 Legacy account redirected to complete-email, stays active

#### Manual

- [ ] 3.8 Prod-like legacy account never locked out, guided to add email
